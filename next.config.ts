        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://api.brainerce.com https://api.stripe.com https://*.vercel-insights.com https://*.vercel-analytics.com https://*.meshulam.co.il https://grow.link https://*.grow.link https://*.grow.security https://devpaybox.grow.security https://paybox.grow.security https://pay.google.com",
              "frame-src 'self' https://js.stripe.com https://hooks.stripe.com https://*.meshulam.co.il https://grow.link https://*.grow.link https://*.grow.security https://pay.google.com",
