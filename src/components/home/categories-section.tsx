...
const categories = [
  {
    ...
    href: '/products?category=' + encodeURIComponent('טבעות'),
  },
  {
    title: 'שרשראות',
    ...
    href: '/products?category=' + encodeURIComponent('שרשראות'),
  },
  {
    title: 'עגילים',
    ...
    href: '/products?category=' + encodeURIComponent('עגילים'),
  },
  {
    title: 'צמידים',
    ...
    href: '/products?category=' + encodeURIComponent('צמידים'),
  },
  {
    title: 'סטים מושלמים',
    category: 'מבצע מיוחד',
