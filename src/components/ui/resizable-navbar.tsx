...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-7xl flex-row items-center justify-between self-start px-4 py-2 lg:flex backdrop-blur-md rounded-full",
        className,
      )}
    >
      {children}
...
export const MobileNav = ({ children, className, visible }: MobileNavProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-50 mx-auto flex w-full max-w-[calc(100vw-2rem)] flex-col items-center justify-between px-4 py-2 lg:hidden backdrop-blur-md rounded-full",
        className,
      )}
    >
      {children}
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className={cn(
            "absolute inset-x-0 top-16 z-50 flex w-full flex-col items-start justify-start gap-4 rounded-lg bg-black/95 backdrop-blur-xl px-4 py-8 shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] dark:bg-neutral-950",
            className,
          )}
          dir="rtl"
        >
...
export const MobileNavToggle = ({
  ...
  return isOpen ? (
    <IconX className={cn("text-white cursor-pointer", className)} onClick={onClick} />
  ) : (
    <IconMenu2 className={cn("text-white cursor-pointer", className)} onClick={onClick} />
  );
};
...
export const NavbarLogo = ({
  ...
  return (
    <div className={cn("relative z-20 flex items-center", className)}>
      {children}
    </div>
  );
};
...
export const NavbarButton = ({
  ...
  children: React.ReactNode;
  className?: string;
  variant?: "primary" | "secondary" | "dark" | "gradient" | "gold";
} & (
  ...
  const variantStyles = {
    ...
    secondary: "bg-transparent text-white shadow-none hover:bg-white/10",
    dark: "bg-black text-white shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]",
    gradient:
      "bg-gradient-to-b from-gold-400 to-gold-600 text-black shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset]",
    gold: "bg-gradient-to-r from-gold-500 to-gold-600 text-black font-semibold shadow-gold-lg hover:from-gold-400 hover:to-gold-500",
  };
