    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "טבעות",
        url: `${baseUrl}/products?category=rings`,
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "שרשראות",
        url: `${baseUrl}/products?category=necklaces`,
      },
      {
        "@type": "ListItem",
        position: 3,
        name: "עגילים",
        url: `${baseUrl}/products?category=earrings`,
      },
      {
        "@type": "ListItem",
        position: 4,
        name: "צמידים",
        url: `${baseUrl}/products?category=bracelets`,
      },
      {
        "@type": "ListItem",
        position: 5,
        name: "תליונים",
        url: `${baseUrl}/products?category=pendants`,
      },
    ],
  },
};
